    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                <p>
                    <a href="/note/create"
                        class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Create
                        note</a>
                </p>
                <?php if (empty($notes)) { ?>
                ...
                <div class="grid md:grid-cols-2 gap-8 mt-4">
                    ...
                    <div
                        ...
                        <a href="/note?id=<?= $note['id'] ?>"
                            class="text-yellow-600 dark:text-yellpw-500 hover:underline font-medium text-lg inline-flex items-center">View
                        ...
                        <a href="/note/edit?id=<?= $note['id'] ?>"
                            class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Edit
