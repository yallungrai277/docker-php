            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                <form method="POST" action="/note/update">
                                ...
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-2">
                                        <input id="title" name="title" type="text"
                                            ...
                                            value="<?= oldFormData('title') ?? $note['title'] ?>">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea id="body" name="body" rows="3"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?= oldFormData('body') ?? $note['body'] ?></textarea>
                                    </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <a href="/notes"
                            class="rounded-md bg-grey-600 px-3 py-2 text-sm font-semibold shadow-sm hover:bg-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-grey-600">Cancel</a>
                        <button type="submit"
